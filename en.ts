export default {
  ...
  pages: {
    home: {
      title: {
        notice:
          "Bitlayer Ready Player I is Now Live! Vote For Points & WLs Now!",
        slogon1: "Extend",
      ...
      solutions: {
        ...
        subtitle:
          "The key pillar solutions for the future of Bitcoin ecosystem",
        items: [
          {
    ...
    developers: {
      title: {
        ...
        subtitle:
          "A manual for joining the Bitlayer ecosystem By builders for builders",
        buildNow: "Build Now",
        blog: "Blog",
      },
      faq: {
      ...
      feature: {
        ...
        desc1:
          "Supports multiple VMs, enables a 100% EVM-Compatible Environment",
      ...
      quickstart: {
        ...
        subtitle:
          "Unlock the Bitlayer ecosystem with a guide crafted by builders, for builders",
        ...
        skill2:
          "This guide walks you through compiling and running Bitlayer to deployment",
        title3: "Fresh Perspectives and Latest Updates Await",
        skill3:
          "Stay tuned for detailed updates on technology and market insights in our blog",
        readMore: "READ MORE",
      },
      tools: {
    ...
    bridge: {
      ...
      connectDesc: "Connect your wallet to transfer tokens",
      bridgeTip:
        "Bridge to Bitlayer, Hold Bitlayer Lucky Helmet, Share 400K BWB Points!",
      historyTab: "History",
    ...
    readyplayone: {
      ...
      rules: {
        ...
        ruleContents: [
          ...
          },
          {
            title: "Launch",
            texts: [
              "Initiate launch on the mainnet and gear up for the impending competition.",
            ],
            date: "Apr-May",
          },
          {
      ...
      setp: {
        ...
        airdrop: {
          deploymentTip:
            "If your project deployment is already complete, well done!",
          description:
            "Details regarding the event's rules and reward allocation will be announced later. By engaging actively, you stand a chance to secure a share of the rewards, valued at an impressive $50 million.",
        },
      },
    },
    luckyhelmet: {
    ...
    rank: {
      ...
      dialog: {
        ...
        expire: {
          ...
          tuned:
            "More details will be shared on our official twitter, please stay tuned!",
          thx: "Thank You!",
    ...
    getGas: {
      ...
      warning:
        "Don&apos;t transfer to an expired address, or you may risk losing tokens",
